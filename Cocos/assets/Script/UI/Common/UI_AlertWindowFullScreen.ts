...
export default class UI_AlertWindowFullScreen extends fgui.GComponent {

	public m_frame:UI_CommonWindowFrame;
	public m_Title:fgui.GTextField;
	public m_Message:fgui.GTextField;
	public m_CodeValue:fgui.GTextField;
	public static URL:string = "ui://bjc65ilgiv7g6";

	public static createInstance():UI_AlertWindowFullScreen {
		return <UI_AlertWindowFullScreen>(fgui.UIPackage.createObject("Common", "AlertWindowFullScreen"));
	}
